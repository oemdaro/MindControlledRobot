...
class MainFrame(wx.Frame):
    ...
    def OnAboutBox(self, e):
        description = """EmoBotControl is a pc application used to control robot.
It interacted with Emotiv EmoKey to get a command for control robot direction.
        """
